...
const Balance = () => {
  ...
  /* 
  Do transfer,
  Notify app that transfer is pending,
  Get confirmation from the blockchain that the transaction was successful,
  Notify app that transfer is successful
  */
  ...
  return (
    <div className="component exchange__transfers">
      ...
      {/* Deposit/Withdraw Component 1 (shr) */}
